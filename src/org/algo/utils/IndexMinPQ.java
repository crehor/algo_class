...
public class IndexMinPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
   ...
   /**
     ...
     * @throws IndexOutOfBoundsException unless (0 &le; k < NMAX)
     */
   ...
   /**
     ...
     * @throws IndexOutOfBoundsException unless 0 &le; k < NMAX
     * @throws IllegalArgumentException if key &ge; key associated with index k
     * @throws java.util.NoSuchElementException no key is associated with index k
     */
   ...
   /**
     ...
     * @throws IndexOutOfBoundsException unless 0 &le; k < NMAX
     * @throws IllegalArgumentException if key &le; key associated with index k
     * @throws java.util.NoSuchElementException no key is associated with index k
     */
